...
### DEMO (in English)
![demo-en](media/infra-support-copilot-en.gif)

### DEMO (in Japanese)
![demo-ja](media/infra-support-copilot-ja.gif)
...
> **Note:** This project currently supports **Windows only**. macOS and Linux support may be added in the future.
